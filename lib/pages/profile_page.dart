            ...
            children: [
              DrawerHeader(
                ...
                child: Container(
                  ...
                  child: Text("Room Mate pairing APP ",
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 20,),
                  Text('BHASHI ', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold),),
                  SizedBox(height: 20,),
                  Text('STUDENT AT IGDTUW', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold),),
                  SizedBox(height: 10,),
                  Container(
                    padding: EdgeInsets.all(10),
                    child: Column(
                                    ...
                                    ...ListTile.divideTiles(
                                      ...
                                      tiles: [
                                        ...
                                        ListTile(
                                          ...
                                          title: Text("Email"),
                                          subtitle: Text("BHASHI.B0001@gmail.com"),
                                        ),
                                        ListTile(
