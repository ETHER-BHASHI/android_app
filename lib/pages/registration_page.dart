                  ...
                  Form(
                    ...
                    child: Column(
                      children: [
                        ...
                        Container(
                          child: TextFormField(
                            decoration: ThemeHelper().textInputDecoration('COURSE ', 'Enter your branch'),
                          ),
                          decoration: ThemeHelper().inputBoxDecorationShaddow(),
                        ),
                        SizedBox(height: 30,),
                                ...
                                setState(() {
                                  showDialog(
                                    ...
                                    builder: (BuildContext context) {
                                      return ThemeHelper().alartDialog("Google Plus","hi bhashi , You tap on GooglePlus social icon.",context);
                                    },
                                  );
                                });
                              },
                              ...
                              onTap: () {
                                setState(() {
                                  showDialog(
                                    context: context,
                                    builder: (BuildContext context) {
                                      return ThemeHelper().alartDialog("Twitter","hi bhashi , You tap on Twitter social icon.",context);
                                    },
                                  );
                                });
                              },
                                  ...
                                  showDialog(
                                    ...
                                    builder: (BuildContext context) {
                                      return ThemeHelper().alartDialog("Facebook",
                                          "hi bhashi, You tapped on Facebook social icon.",
                                          context);
                                    },
                                  );
                                });
